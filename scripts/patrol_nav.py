...
class PatrolNav():
    ...
    def __init__(self):
        ...
        self.locations = dict()
        self.locations['one']   = Pose(Point(2.808,  -0.760, 0.000), Quaternion(0.000, 0.000, -0.384, 0.923))
        self.locations['two']   = Pose(Point(3.650,  -3.008, 0.000), Quaternion(0.000, 0.000, 0.904,  -0.428))
        self.locations['three'] = Pose(Point(0.401,  -4.002, 0.000), Quaternion(0.000, 0.000, 0.960, 0.279))
        self.locations['four']  = Pose(Point(-0.138,  -5.366, 0.000), Quaternion(0.000, 0.000, -0.577, 0.816))
        self.locations['five']  = Pose(Point(-1.435,  -2.728, 0.000), Quaternion(0.000, 0.000, 0.964,  0.267))
        self.locations['six']   = Pose(Point(-1.809,  -1.291, 0.000), Quaternion(0.000, 0.000, 0.453, 0.892))
